...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookingsForUser = channel.unary_unary(
                ...
                response_deserializer=booking__pb2.UserBooking.FromString,
                _registered_method=True)
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBookingsForUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=booking__pb2.UserBooking.SerializeToString,
            ),
...
class Booking(object):
    ...
    def GetBookingsForUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            booking__pb2.UserBooking.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
